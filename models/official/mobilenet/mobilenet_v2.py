...
import mobilenet_v2_model as mobilenet_v2
...
#    with arg_scope(mobilenet_v2.training_scope()):
...
def main(unused_argv):
  ...
  run_config = tpu_config.RunConfig(
      ...
      model_dir=FLAGS.model_dir,  # this is actually train_dir?
...
##### Yi Xu
  mobilenetv2_classifier = tpu_estimator.TPUEstimator(
      model_fn=model_fn,
      use_tpu=FLAGS.use_tpu,
      config=run_config,
      params=params,
...
#        eval_results = inception_classifier.evaluate(
        eval_results = mobilenetv2_classifier.evaluate(
